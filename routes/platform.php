...
Route::screen('userinfo', \App\Orchid\Screens\UserInfoScreen::class)
    ->name('platform.systems.userinfo')
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push(__('UserInfo'), route('platform.systems.userinfo')));


Route::screen('communications', \App\Orchid\Screens\System\CommunicationsScreen::class)
    ->name('platform.systems.communications')
    /*->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index.system')
        ->push(__('Communications'), route('platform.systems.communications')))*/;

Route::screen('captcha', \App\Orchid\Screens\System\CaptchaScreen::class)
    ->name('platform.systems.captcha')
    /*->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index.system')
...
Route::screen('products/default/{id}', \App\Orchid\Screens\Products\Defs::class)
